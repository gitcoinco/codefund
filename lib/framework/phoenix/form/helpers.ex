defmodule Framework.Phoenix.Form.Helpers do
  ...
  @spec repo_objects_to_options(list) :: Keyword.t()
  def repo_objects_to_options(objects) do
    objects |> Keyword.new(fn object -> {object.name |> String.to_atom(), object.id} end)
  end
