...
defmodule CodeSponsorWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: CodeSponsorWeb.Coherence.EmailView, layout: {CodeSponsorWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
