defmodule CodeSponsorWeb.Coherence.RegistrationController do
  @moduledoc """
  ...
  * delete - delete the user account
  ...
  def show(conn, _) do
    ...
    render(conn, "show.html", user: user, layout: {CodeSponsorWeb.LayoutView ,"admin.html"})
  end
  ...
  def edit(conn, _) do
    ...
    render(conn, "edit.html", user: user, changeset: changeset, layout: {CodeSponsorWeb.LayoutView ,"admin.html"})
  end
